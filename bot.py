...
def generate_content(trends, mode="social"):
    ...
    prompt = f"Sen @olanlarsakami hesabının {persona} editörüsün. Veriler: {trends}. [GÖREV] Sadece Türkçe kullanarak, vizyoner ve ferah bir içerik üret. 'Ferah' kelimesini kullanma, hissettir."
